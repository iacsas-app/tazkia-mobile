...
export enum TKeys {
  ...
  PURIFICATION_BODYPART_ADD_CLEANING_PHASE = 'purification.bodypart.add.cleaning-phase',
  PURIFICATION_BODYPART_ADD_ENLIGHTENMENT_PHASE = 'purification.bodypart.add.enlightenment-phase',
  PURIFICATION_BODYPART_CLEANING_PHASE = 'purification.bodypart.cleaning.step',
  PURIFICATION_BODYPART_ENLIGHTENMENT_PHASE = 'purification.bodypart.enlightenment.step',
