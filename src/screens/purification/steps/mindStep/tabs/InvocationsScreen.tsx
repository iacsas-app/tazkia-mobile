  ...
  const items = [
    {
      ...
      imageSource: require('../../../../../../assets/img/invocations/dikr_haylala/haylala_1.png'),
    },
    {
      text: formatMessage(TKeys.INVOCATION_STEP_2_RULE_2_CROYANCE_2),
      imageSource: require('../../../../../../assets/img/invocations/dikr_haylala/haylala_2.png'),
    },
    {
      text: formatMessage(TKeys.INVOCATION_STEP_2_RULE_2_CROYANCE_3),
      imageSource: require('../../../../../../assets/img/invocations/dikr_haylala/haylala_3.png'),
    },
